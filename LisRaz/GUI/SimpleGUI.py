...
class SimpleGUI:
    def __init__(self):
        ...
        self.view2 = Label()
        self.view2.grid(row=0, column=1, columnspan=2)
        ...
        self.prog_label = Label(self.tools, text="Program: LIS<=>RÁŽ", font=("Courier", 40))
    ...
    def run(self):
        ...
        while True:
            ...
            indicator = pictures["orig"]
            indicator = cv2.resize(indicator, (960, 720))
