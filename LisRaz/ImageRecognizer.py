...
class ImageRecognizer:
    ...
    def evaluation(self):
        ...
        circled = self.find_circle.compute(differed, min_rad=80, max_rad=120, min_dist=30)
        ...
        evaluated = self.eval.compute(circled)
...
class GuiProvider(ImageRecognizer):
    ...
    def show_loop(self, settings):
        ...
        return {
            ...
            "circled": self.find_circle.circled
        }
